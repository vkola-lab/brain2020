...
def function(fil_num, drop_rate, batch_size, learning_rate, train_epochs, balanced, roi_threshold):
    ...
    command = ['/home/sq/.conda/envs/RL/bin/python', 'mlp_main.py', filename]
