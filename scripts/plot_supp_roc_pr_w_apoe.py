# -*- coding: utf-8 -*-
"""
Created on Sat Jun  1 22:28:43 2019
...
dw.load(data_root, ['ADNI', 'FHS', 'AIBL', 'NACC'], roi)
print('Done.')

# remove rows with missing values
dw.keep_data_completeness(['X_mmse', 'X_apoe'])
...
Xb, X_, y = {}, {}, {}
for m, c in zip(['B', 'C'],
                [['X_mmse', 'X_apoe', 'X_age', 'X_gender'],
                 ['X_rmap', 'X_mmse', 'X_apoe', 'X_age', 'X_gender']]):
...
if not load:
    ...
    models_bag['B'].load('./saved_mlp/main_1561434123_B')
    models_bag['C'].load('./saved_mlp/main_1561434123_C')
    print('Done.')
