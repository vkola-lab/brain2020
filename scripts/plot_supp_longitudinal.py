# -*- coding: utf-8 -*-
"""
Created on Tue Jun 18 00:22:55 2019
...
dw.load(data_root, dsets, roi, longitudinal=True)
print('Done.')

# remove rows with missing values
dw.keep_data_completeness(['X_mmse', 'X_ravlt_fgt'])
...
for m, c in zip(['RAVLT', 'MMSE'],
    ...
    Xb[m], X_[m], y = dw.get_ndarray(cols=c, longitudinal=True)
print('Done.')
...
if not load:
    ...
    models_bag['RAVLT'].load('./saved_mlp/main_1561674191_RAVLT')
    models_bag['MMSE'].load('./saved_mlp/main_1561674191_MMSE')
    print('Done.')
